...
import { updateUserStart, updateUserSuccess,
   updateUserFailure, deleteUserFailure, deleteUserStart, deleteUserSuccess, 
    ...
    <div className="p-3 max-w-lg mx-auto">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
           <span className="text-red-700">Error Image upload(image must be less than 2 mb)
            ...
            <span className="text-silate-700">
                {`Uploading ${filePerc}%`}
            </span>)
            :
            filePerc === 100 ? (
      ...
      {userListings.map((listing) => (
        <div key={listing._id}  className="border rounded-lg p-3 flex justify-between items-center gap-4">
            ...
            <Link className='text-slate-700 font-semibold hover:underline truncateflex-1' 
